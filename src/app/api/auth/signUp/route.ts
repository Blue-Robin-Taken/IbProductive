...
export async function POST(request: Request) {
    ...
    await resend.emails.send({
        ...
        html: `<h1>Welcome To IBProductive!</h1> <br> <p>Here is your verification link:${verification_link} \n If you got this email without sending it yourself, please contact us.</p>`,
    });
